...
export class BookCarComponent {
  showDateInputs: boolean = false; // Declaration of showDateInputs outside of constructor
  ...
  cancelBooking(booking: any) {
    ...
    // You can make API calls or update the booking status as per your application's requirements
  }
}
