                            ...
                            <table class="table table-striped">
                                <thead class="thead-dark">
                                    <tr>
                                        ...
                                        <th width="10%"> AC Fare (/km) </th>
                                        <th width="10%"> Non-AC Fare (/km)</th>
                                        <th width="10%"> AC Fare (/day)</th>
                                        <th width="10%"> Non-AC Fare (/day)</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="update_car_form.php?car_id=<?php echo $row["car_id"]; ?>" class="btn btn-primary btn-sm" style="margin-right: 5px;">Update</a>
                                                <a href="delete_car.php?car_id=<?php echo $row["car_id"]; ?>" class="btn btn-danger btn-sm">Delete</a>
